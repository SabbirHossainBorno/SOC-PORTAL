...
/**
 * Creates admin and user notifications in the database.
  ...
  try {
    ...
    logger.debug('Notifications created successfully', {
      meta: {
        ...
        sid: sessionId,
        taskName: 'CreateNotifications',
        details: `Created admin notification ${adminNotificationId} and user notification ${userNotificationId}`,
        userId: socPortalId,
        ipAddress,
        userAgent,
        adminNotificationId,
