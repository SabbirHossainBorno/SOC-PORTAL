...
const ReliabilityBarChart = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      if (response.ok && data.success) {
        ...
        console.log('fetchData Success for reliability impact:', { 
          responseData: data.data,
          channels: data.data.channels,
          overallReliability: data.data.reliabilityPercentage
        });
      } else {
  ...
  // Prepare bar chart data with 2 decimal places
const prepareBarChartData = () => {
  ...
  const reliabilityData = chartData.channels.map(channel => parseFloat(channel.reliabilityPercentage.toFixed(2)));
    ...
    tooltip: {
      callbacks: {
        label: (context) => {
          ...
          const reliabilityValue = parseFloat(context.parsed.y).toFixed(2);
          const lines = [
          ...
          if (channel?.minutes === 0) {
            ...
            const impactValue = channel?.percentage ? parseFloat(channel.percentage).toFixed(2) : '0.00';
            lines.push(`Impact: ${impactValue}%`);
          }
    ...
    >
      ...
      {loading ? (
              ...
              {chartData.channels.map((channel, index) => (
                ...
                >
                  <div className="flex justify-between items-start mb-1.5">
                    ...
                    >
                      {channel.reliabilityPercentage.toFixed(2)}%
                    </div>
                  </div>
          ...
          <div className="mt-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-1.5">
              <div className="bg-green-50 py-1 px-1 rounded text-center">
                ...
                <p className="text-sm font-bold text-green-900 leading-tight mt-0.5">
                  {chartData.reliabilityPercentage.toFixed(2)}%
                </p>
              ...
              <div className="bg-red-50 py-1 px-1 rounded text-center">
                ...
                <p className="text-sm font-bold text-red-900 leading-tight mt-0.5">
                  {chartData.reliabilityImpactPercentage.toFixed(2)}%
                </p>
              ...
              <div className="bg-purple-50 py-1 px-1 rounded text-center">
                ...
                <p className="text-sm font-bold text-purple-900 leading-tight mt-0.5">
                  {chartData.summary.reliabilityStatus}
                </p>
        ...
        <div className="flex-1 flex flex-col items-center justify-center py-10">
          ...
          {/* Date Range Display for empty state */}
