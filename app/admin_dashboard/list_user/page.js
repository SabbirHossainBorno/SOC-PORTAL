...
import { FaUser, FaEnvelope, FaIdCard, FaBriefcase, FaSearch, FaFilter, FaSync, FaChevronDown } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-6 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded p-3 sm:p-4 shadow-md">
            <div className="text-xl sm:text-2xl md:text-3xl font-bold">{users.length}</div>
            <div className="mt-1 text-xs sm:text-sm">Total Users</div>
          </div>
          
          <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded p-3 sm:p-4 shadow-md">
            <div className="text-xl sm:text-2xl md:text-3xl font-bold">
              {users.filter(u => u.status === 'Active').length}
            </div>
            <div className="mt-1 text-xs sm:text-sm">Active Users</div>
          </div>
          
          <div className="bg-gradient-to-r from-amber-500 to-orange-600 text-white rounded p-3 sm:p-4 shadow-md">
            <div className="text-xl sm:text-2xl md:text-3xl font-bold">
              {users.filter(u => u.role_type === 'SOC').length}
            </div>
            <div className="mt-1 text-xs sm:text-sm">SOC Team</div>
          </div>
          
          <div className="bg-gradient-to-r from-purple-500 to-fuchsia-600 text-white rounded p-3 sm:p-4 shadow-md">
            <div className="text-xl sm:text-2xl md:text-3xl font-bold">
              {users.filter(u => u.role_type === 'OPS').length}
            </div>
            <div className="mt-1 text-xs sm:text-sm">OPS Team</div>
          </div>
        </motion.div>
