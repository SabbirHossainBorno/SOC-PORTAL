                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                    ...
                    <div className="lg:col-span-3">
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <p className="text-slate-800 font-semibold flex-1 bg-slate-50 p-3 rounded border border-slate-200 break-all">
                ...
                {portals.map((portal, index) => (
                  ...
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
                      ...
                      <div className="lg:col-span-3">
                        <div className="flex items-center gap-2">
                          <div className="text-sm font-medium text-slate-800 truncate flex-1">
                            {portal.user_identifier}
                          </div>
                          <button
                            onClick={() => copyToClipboard(portal.user_identifier, 'User ID')}
