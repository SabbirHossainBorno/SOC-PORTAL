...
export default function OtherDocumentTracker() {
  ...
  const handleTypeSelect = (type) => {
    ...
    // Navigate to the specific tracker page
    if (type === 'DeviceTracker') {
      router.push('/user_dashboard/document_hub/other_document_tracker/device_tracker');
    }
    // Add other type navigations as needed
  };
